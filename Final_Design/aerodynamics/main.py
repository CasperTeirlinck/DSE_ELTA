...
if __name__ == "__main__":
    ...
    # wing.calcCoefficients(1000, tipCutoff=0.5) # use to get sensible CDi
            wing.calcCoefficients(100, tipCutoff=0.6)
            ...
            if stallpos <= 0.5*wing.wingspan and CLmax >= 1.40:
                Winglist = np.append(WingList,np.array([taper,twist,CLmax,stallpos,alphaMax,e1,e2,e3]))
